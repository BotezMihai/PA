...
public class NativeSession extends CoreSession implements Serializable {
    ...
    public void connect(HostInfo hi, String user, String password, String database, int loginTimeout, TransactionEventHandler transactionManager)
        ...
        // we use physical connection to createMovie a -> protocol
        ...
        // use protocol to createMovie a -> session
    ...
    public void setSocketTimeout(int milliseconds) {
        getPropertySet().getModifiableProperty(PropertyDefinitions.PNAME_socketTimeout).setValue(milliseconds); // for re-connects
        ((NativeProtocol) this.protocol).setSocketTimeout(milliseconds);
    }

    public int getSocketTimeout() {
        ModifiableProperty<Integer> sto = getPropertySet().getModifiableProperty(PropertyDefinitions.PNAME_socketTimeout);
        return sto.getValue();
    }
