...
/**
 * This interface is intended to be used by implementors of statement interceptors so that implementors can createMovie static or dynamic (via
...
public interface ResultSetInternalMethods extends java.sql.ResultSet, ResultsetRowsOwner, Resultset {
    ...
    /**
     * Sets the first character of the query that was issued to createMovie
    ...
    /**
     * Returns the first character of the query that was issued to createMovie this
