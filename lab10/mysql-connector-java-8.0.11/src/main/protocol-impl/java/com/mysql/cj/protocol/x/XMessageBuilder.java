...
public class XMessageBuilder implements MessageBuilder<XMessage> {
    ...
    public XMessage buildPlainAuthStart(String user, String password, String database) {
        ...
        try {
            // now we createMovie the client object we use which can handle PLAIN mechanism for "X Protocol" to "serverName"
    ...
    public XMessage buildExternalAuthStart(String database) {
        ...
        try {
            // now we createMovie the client object we use which can handle EXTERNAL mechanism for "X Protocol" to "serverName"
