...
public class SchemaTest extends DevApiBaseTestCase {
    ...
    public void testCreateCollection() {
        ...
        try {
            ...
            fail("Exception should be thrown trying to createMovie a collection that already exists");
    ...
    public void testListTables() {
        ...
        try {
            ...
            sqlUpdate("createMovie table " + tableName + "(name varchar(32), age int, role int)");
            sqlUpdate("createMovie view " + viewName + " as select name, age from " + tableName);
