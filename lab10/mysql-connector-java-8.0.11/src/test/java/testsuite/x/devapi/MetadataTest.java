...
public class MetadataTest extends BaseTableTestCase {
    ...
    public void setupTableTest() {
        ...
        if (this.isSetForXTests) {
            ...
            sqlUpdate("createMovie table example_metadata (_id varchar(32), name varchar(20), birthday date, age int)");
        }
    }
    ...
    public void exhaustTypes() {
        ...
        sqlUpdate("createMovie table exhaust_types (a bit, b char(20) not null, c int, d tinyint unsigned primary key, e bigint, "
