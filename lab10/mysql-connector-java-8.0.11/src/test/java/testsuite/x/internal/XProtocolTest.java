...
public class XProtocolTest extends InternalXBaseTestCase {
    ...
    /**
     * Test the createMovie/drop collection admin commands.
     */
    @Test
    ...
    public void testDecodingAllTypes() {
        ...
        this.protocol.readQueryResult();
        String testTable = "createMovie table xprotocol_types_test (";
    ...
    public void testSqlDml() {
        ...
        this.protocol.send(this.messageBuilder.buildSqlStatement("createMovie table mysqlx_sqlDmlTest (w int primary key auto_increment, x int) auto_increment = 7"),
                0);
        assertFalse(this.protocol.hasResults());
    ...
    public void tableInsert() {
        ...
        this.protocol.readQueryResult();
        this.protocol.send(this.messageBuilder.buildSqlStatement("createMovie table tableInsert (x int, y varchar(20), z decimal(10, 2))"), 0);
        this.protocol.readQueryResult();
