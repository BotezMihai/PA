    ...
    public static SSLContext getSSLContext(String clientCertificateKeyStoreUrl, String clientCertificateKeyStoreType, String clientCertificateKeyStorePassword,
        ...
        if (!StringUtils.isNullOrEmpty(clientCertificateKeyStoreUrl)) {
            ...
            try {
                ...
                throw ExceptionFactory.createException(SSLParamsException.class, "Could not createMovie KeyStore instance [" + kse.getMessage() + "]", kse,
                        exceptionInterceptor);
        ...
        try {
            ...
            throw ExceptionFactory.createException(SSLParamsException.class, "Could not createMovie KeyStore instance [" + e.getMessage() + "]", e,
                    exceptionInterceptor);
