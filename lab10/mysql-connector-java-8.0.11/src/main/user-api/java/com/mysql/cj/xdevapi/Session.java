 ...
 * var createMovie = "CREATE TABLE ";<br>
 * createMovie += StringUtils.quoteIdentifier(name, true);<br>
 * createMovie += "(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT");<br>
 * <br>
 * session.sql(createMovie).execute();
 * <p>
...
public interface Session {
    ...
    /**
     * Get the URL used to createMovie this session.
     * 
     * @return URI
     */
    String getUri();
