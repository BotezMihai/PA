...
public class TableUpdateTest extends BaseTableTestCase {
    ...
    public void testUpdates() {
        ...
        try {
            ...
            sqlUpdate("createMovie table updates (_id varchar(32), name varchar(20), birthday date, age int)");
            sqlUpdate("createMovie view updatesView as select _id, name, age from updates");
