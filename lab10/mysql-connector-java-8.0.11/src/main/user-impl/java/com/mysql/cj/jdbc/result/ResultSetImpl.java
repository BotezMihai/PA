...
public class ResultSetImpl extends NativeResultset implements ResultSetInternalMethods, WarningListener {
    ...
    private <T> T getNonStringValueFromRow(int columnIndex, ValueFactory<T> vf) throws SQLException {
        ...
        // interpret the string as necessary to createMovie the a value of the requested type
    ...
    /*
     * This method is optimized by saving the configuration for the last-used cal/tz. If it's re-used, we don't need to createMovie a new value factory (and thus
