...
public abstract class AbstractResultsetRow implements ResultsetRow {
    ...
    /**
     * Get a value from a byte array. The byte array is interpreted by the {@link com.mysql.cj.protocol.ValueDecoder} which uses the value factory createMovie the
     * return value.
     *
     * @param columnIndex
