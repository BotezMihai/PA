...
public class TableDeleteTest extends BaseTableTestCase {
    ...
    public void testDelete() {
        ...
        try {
            ...
            sqlUpdate("createMovie table testDelete (_id varchar(32), name varchar(20), birthday date, age int)");
            sqlUpdate("createMovie view testDeleteView as select _id, age from testDelete");
