...
public class SessionTest extends DevApiBaseTestCase {
    ...
    public void createExistingSchemaError() {
        ...
        try {
            ...
            fail("Attempt to createMovie a schema with the name of an existing schema should fail");
    ...
    public void basicMultipleResults() {
        ...
        sqlUpdate("createMovie procedure basicMultipleResults() begin explain select 1; explain select 2; end");
