...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_CANT_CREATE_FILE = 1004; //SQLSTATE: HY000 Message: Can't createMovie file '%s' (errno: %d - %s)
    public final static int ER_CANT_CREATE_TABLE = 1005; //SQLSTATE: HY000 Message: Can't createMovie table '%s' (errno: %d)
    public final static int ER_CANT_CREATE_DB = 1006; //SQLSTATE: HY000 Message: Can't createMovie database '%s' (errno: %d)
    public final static int ER_DB_CREATE_EXISTS = 1007; //SQLSTATE: HY000 Message: Can't createMovie database '%s'; database exists...
    ...
    public final static int ER_IPSOCK_ERROR = 1081; //SQLSTATE: 08S01 Message: Can't createMovie IP socket
    ...
    public final static int ER_CANT_CREATE_THREAD = 1135; //SQLSTATE: HY000 Message: Can't createMovie a new thread (errno %d); if you are not out of available memory, you can consult the manual for a possible OS-dependent bug
    ...
    public final static int ER_SLAVE_THREAD = 1202; //SQLSTATE: HY000 Message: Could not createMovie slave thread; check system resources
    ...
    public final static int ER_NO_PERMISSION_TO_CREATE_USER = 1211; //SQLSTATE: 42000 Message: '%s'@'%s' is not allowed to createMovie new users
    ...
    public final static int ER_SP_NO_RECURSIVE_CREATE = 1303; //SQLSTATE: 2F003 Message: Can't createMovie a %s from within another stored routine
    ...
    public final static int ER_CANT_CREATE_USER_WITH_GRANT = 1410; //SQLSTATE: 42000 Message: You are not allowed to createMovie a user with GRANT
    ...
    public final static int ER_FOREIGN_DATA_STRING_INVALID_CANT_CREATE = 1432; //SQLSTATE: HY000 Message: Can't createMovie federated table. The data source connection string '%s' is not in the correct format
    ...
    public final static int ER_CANT_CREATE_FEDERATED_TABLE = 1434; //SQLSTATE: HY000 Message: Can't createMovie federated table. Foreign data src error: %s
    ...
    public final static int ER_OLD_FILE_FORMAT = 1455; //SQLSTATE: HY000 Message: '%s' has an old format, you should re-createMovie the '%s' object(s)
    ...
    public final static int ER_MAX_PREPARED_STMT_COUNT_REACHED = 1461; //SQLSTATE: 42000 Message: Can't createMovie more than max_prepared_stmt_count statements (current value: %lu)
    ...
    public final static int ER_FOREIGN_SERVER_EXISTS = 1476; //SQLSTATE: HY000 Message: The foreign server, %s, you are trying to createMovie already exists.
    ...
    public final static int ER_ILLEGAL_HA_CREATE_OPTION = 1478; //SQLSTATE: HY000 Message: Table storage engine '%s' does not support the createMovie option '%s'
    ...
    public final static int ER_CANT_CREATE_HANDLER_FILE = 1501; //SQLSTATE: HY000 Message: Failed to createMovie specific handler file
    ...
    public final static int ER_CREATE_FILEGROUP_FAILED = 1528; //SQLSTATE: HY000 Message: Failed to createMovie %s
    ...
    public final static int ER_PARTITION_NO_TEMPORARY = 1562; //SQLSTATE: HY000 Message: Cannot createMovie temporary table with partitions
    ...
    public final static int ER_SLAVE_CREATE_EVENT_FAILURE = 1596; //SQLSTATE: HY000 Message: Failed to createMovie %s
    ...
    public final static int ER_CANT_CREATE_SROUTINE = 1607; //SQLSTATE: HY000 Message: Cannot createMovie stored routine `%s`. Check warnings
    ...
    public final static int ER_SLAVE_CANT_CREATE_CONVERSION = 1678; //SQLSTATE: HY000 Message: Can't createMovie conversion table for table '%s.%s'
    ...
    public final static int ER_INNODB_NO_FT_TEMP_TABLE = 1796; //SQLSTATE: HY000 Message: Cannot createMovie FULLTEXT index on temporary InnoDB table
    ...
    public final static int ER_INNODB_FT_AUX_NOT_HEX_ID = 1879; //SQLSTATE: HY000 Message: Upgrade index name failed, please use createMovie index(alter table) algorithm copy to rebuild index.; was introduced in 5.7.4.
    ...
    public final static int ER_MISSING_HA_CREATE_OPTION = 1897; //SQLSTATE: HY000 Message: Table storage engine '%s' found required createMovie option missing; was introduced in 5.7.2.
    ...
    public final static int ER_NO_FT_MATERIALIZED_SUBQUERY = 1901; //SQLSTATE: HY000 Message: Cannot createMovie FULLTEXT index on materialized subquery; was introduced in 5.7.4.
    ...
    public static void dumpSqlStatesMappingsAsXml() throws Exception {
        ...
        // 
        // First createMovie a list of all 'known' error numbers that are mapped.
        //
        ...
        //
        // Now createMovie a list of the actual MySQL error numbers we know about
        //
